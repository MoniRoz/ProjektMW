...
public class VehicleDTO {
    ...
    private VehicleDTO(PojazdDTOBuilder builder) {
    ...
    public static class PojazdDTOBuilder {
        private String rodzaj_pojazdu;
        private String marka;
        private String typ;
        private String model;
        ...
        public PojazdDTOBuilder rodzaj_pojazdu(String rodzaj_pojazdu) {
            this.rodzaj_pojazdu = rodzaj_pojazdu;
            return this;
        }

        public PojazdDTOBuilder marka(String marka) {
            this.marka = marka;
            return this;
        }

        public PojazdDTOBuilder typ(String typ) {
            this.typ = typ;
            return this;
        }

        public PojazdDTOBuilder model(String model) {
            this.model = model;
            return this;
        }

        public PojazdDTOBuilder rok_produkcji(int rok_produkcji) {
            this.rok_produkcji = rok_produkcji;
            return this;
        }

        public PojazdDTOBuilder nr_VIN(String nr_VIN) {
            this.nr_VIN = nr_VIN;
            return this;
        }

        public PojazdDTOBuilder nr_silnika(String nr_silnika) {
            this.nr_silnika = nr_silnika;
            return this;
        }

        public PojazdDTOBuilder d_nr_rejestracyjny(String d_nr_rejestracyjny) {
            this.d_nr_rejestracyjny = d_nr_rejestracyjny;
            return this;
        }

        public PojazdDTOBuilder nr_kart_pojazdu(String nr_kart_pojazdu) {
            this.nr_kart_pojazdu = nr_kart_pojazdu;
            return this;
        }

        public PojazdDTOBuilder przebieg_p_w_km(int przebieg_p_w_km) {
            this.przebieg_p_w_km = przebieg_p_w_km;
            return this;
        }

        public PojazdDTOBuilder barwa_nadwozia(String barwa_nadwozia) {
            this.barwa_nadwozia = barwa_nadwozia;
            return this;
        }
