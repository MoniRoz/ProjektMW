export class Samochod {
  ...
  constructor(rodzaj_pojazdu: string, marka: string, typ: string, model: string, rok_produkcji: number, nr_VIN: string, nr_silnika: string, d_nr_rejestracyjny: string, nr_kart_pojazdu: string, przebieg_p_w_km: string, barwa_nadwozia: string) {
